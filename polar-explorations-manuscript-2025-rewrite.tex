...
\include{chapters/ch1-new}  %background
\include{chapters/ch2}  %getting started
\include{chapters/ch3}  %advanced
\include{chapters/ch4}  %beyond
\include{chapters/ch5}  %usage
\include{chapters/ch6}  %practical guide
\include{chapters/ch7}  %conclusions

\appendix
\include{chapters/ch8}  %quick ref
