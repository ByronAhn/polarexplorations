...
#figure(
  image("figures/out_of_order-ranges-basic--7.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-greenish_banana-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-greenish_banana-another-basic.png", width: 87.5%), caption: [
...
#box(image("figures/Praat-time-step-settings.png", width: 47.5%)) #box(image("figures/Praat-adv-pitch-settings.png", width: 47.5%))
...
#figure(
  image("figures/PrStr-vegetable_list-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-menu_eleven-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-librivox-zip1-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-amelia_knew1-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-amelia_knew2-basic.png", width: 87.5%), caption: [
...
#figure(image("figures/PrStr-minimum-basic.png", width: 87.5%), caption: [
...
#figure(image("figures/PrStr-me-basic.png", width: 87.5%), caption: [
...
#figure(image("figures/PrStr-no_cigar-basic.png", width: 87.5%), caption: [
`no_cigar`, with the PrStr tier annotated.
])
#label("fig:no_cigar.PrStr")

#figure(
  image("figures/PrStr-spoon_here-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-tomorrow_morning-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-out_of_order_huh-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/PrStr-really_would_not_annoy-basic.png", width: 87.5%), caption: [
...
#figure(image("figures/Points-amelia_knew2-f0.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-amelia_knew2-f0-dots.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-amelia_knew2-basic-dots.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-amelia_knew2-resynth.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-amelia_knew2-before-SLA.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-amelia_knew2-resynth-extra.png", width: 87.5%), caption: [
...
#figure(
  [#box(image("figures/Points-nanasanana.png", width: 48.5%))~~#box(image("figures/Points-nanasanana-resynth.png", width: 48.5%))
...
#figure(
  image("figures/Points-minimum-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-me-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-out_of_order-plateau-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-out_of_order-plateau-resynth-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-really_would_not_annoy-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-raining-creaky-basic-comma.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-raining-creaky-resynth-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-out_of_order_huh-basic-comma.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-greenish_banana-basic-comma.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-stein-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Points-stein-basic-resynth.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Ranges-advice-falsetto-basic-all-3-ranges.png", width: 100%), caption: [
...
#figure(
  image("figures/Ranges-advice-falsetto-basic-first-range.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Ranges-amelia_knew2-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Ranges-greenish_banana-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Ranges-no_cigar-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Ranges-tomorrow_morning-basic.png", width: 87.5%), caption: [
...
#figure(
  image("figures/Appendix-joey.png", width: 87.5%), caption: [
...
#figure(
  [#box(image("figures/Appendix-joey.png", width: 48.5%))~~#box(image("figures/Appendix-joey.png", width: 48.5%))
...
#figure(image("figures/Appendix-joey.png", width: 87.5%), caption: [
...
#figure(
  [#box(image("figures/Appendix-joey.png", width: 87.5%))
...
#figure(
  image("figures/Appendix-joey.png", width: 100%), caption: [
...
#figure(
  image(
    "figures/out_of_order-ranges-1RangeInterval-rainbow.png", width: 87.5%,
  ), caption: [
...
#figure(
  image(
    "figures/out_of_order-ranges-2RangeIntervals-noparens-rainbow.png", width: 87.5%,
  ), caption: [
...
#figure(
  image("figures/Appendix-joey.png", height: 2.75in), caption: [
...
#figure(
  image(
    "figures/Appendix-joey.png", width: 87.5%,
  ), caption: [
...
#figure(
  [#box(
      image(
        "figures/out_of_order-ranges-1RangeInterval-rainbow.png", width: 48.5%,
      ),
    )~~#box(
      image("figures/Appendix-joey.png", width: 48.5%),
    )
...
#figure(
  [#box(
      image(
        "figures/Appendix-joey.png", width: 48.5%,
      ),
    ) #box(
      image(
        "figures/Appendix-joey.png", width: 48.5%,
...
#figure(
  image("figures/Appendix-joey.png", width: 60%), caption: [
...
- To test if it has been installed properly, open Praat (if Praat is open, close and re-open it), and open a Sound file and a TextGrid file.
  ...
  - If the plugin has been installed directly, on the right hand side of the the Praat Objects window, you will see three drop-down menus: PoLaR Straight Line Approx., PoLaR TextGrids and Draw Sound and TextGrid \
    #box(image("figures/Appendix-joey.png", width: 3.75in))
  ...
  - Similarly, in an Editor window, the Tier tab menu shows PoLaR plugin commands – it has fewer options but includes links to the most critical scripts \
    #box(image("figures/Appendix-joey.png", width: 4.5in))
...
- The "Straight Line Approximations" commands can be used to create an f0 contour based on PoLaR Points labels.
  ...
  - #box(image("figures/Appendix-joey.png", width: 4in))
